#!/usr/bin/env python3
"""Assemble rendered Issue #16 slide PNGs into a presentation PDF."""
...
SLIDES_DIR = ROOT / "tmp" / "artifacts" / "issue-16" / "rendered"
OUTPUT = ROOT / "output" / "pdf" / "techflow-backup-recovery-presentation.pdf"
...
def build() -> None:
    ...
    pdf.setTitle("TechFlow 상태 백업·복구 검증")
