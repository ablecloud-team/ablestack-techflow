...
story=[
    ...
    para("6. 운영 상태와 롤백","h1"),
    make_table([["항목","상태"],["Gateway","issue-72-large-uploads-1g10g · healthy"],["Poller","반복 처리 failed=0"],["Maintainer","level=ok · 디스크 11%"],
                ["Flarum 여유","955 GiB"],["TechFlow 여유","916,826,116,096 bytes"],["보호 서비스","frozen · guard passed"]],[62*mm,112*mm]),
