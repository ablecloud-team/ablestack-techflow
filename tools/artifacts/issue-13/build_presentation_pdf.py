#!/usr/bin/env python3
"""Assemble rendered Issue #13 slide PNGs into a presentation PDF."""
...
SLIDES_DIR = ROOT / "tmp" / "artifacts" / "issue-13" / "rendered"
OUTPUT = ROOT / "output" / "pdf" / "activepieces-compose-deployment-presentation.pdf"
...
def build() -> None:
    ...
    pdf.setTitle("Activepieces Compose 배포 검증")
