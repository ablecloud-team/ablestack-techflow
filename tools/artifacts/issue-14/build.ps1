...
$workspace = Join-Path $repoRoot "tmp\artifacts\issue-14"
$templateInspect = Join-Path $workspace "template-inspect"
$rendered = Join-Path $workspace "rendered"
$sourceDeck = Join-Path $repoRoot "output\presentation\activepieces-compose-deployment.pptx"
$presentationOutput = Join-Path $repoRoot "output\presentation\https-webhook-ingress.pptx"
...
Write-Host "Issue #14 artifacts generated."
