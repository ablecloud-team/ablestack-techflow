...
$workspace = Join-Path $repoRoot "tmp\artifacts\issue-12"
...
$presentationOutput = Join-Path $repoRoot "output\presentation\techflow-responsibility-boundary.pptx"
...
Write-Host "Issue #12 artifacts generated."
