#!/usr/bin/env python3
"""Assemble rendered Issue #12 slide PNGs into a presentation PDF."""
...
SLIDES_DIR = ROOT / "tmp" / "artifacts" / "issue-12" / "rendered"
OUTPUT = ROOT / "output" / "pdf" / "techflow-responsibility-boundary-presentation.pdf"
...
def build() -> None:
    ...
    pdf.setTitle("TechFlow와 Activepieces 책임 경계 ADR")
