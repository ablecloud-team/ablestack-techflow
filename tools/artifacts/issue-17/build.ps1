...
$workspace = Join-Path $repoRoot "tmp\artifacts\issue-17"
$templateInspect = Join-Path $workspace "template-inspect"
$rendered = Join-Path $workspace "rendered"
$sourceDeck = Join-Path $repoRoot "output\presentation\techflow-backup-recovery.pptx"
$presentationOutput = Join-Path $repoRoot "output\presentation\techflow-observability.pptx"
...
$audit = @"
Source: output/presentation/techflow-backup-recovery.pptx
...
Write-Host "Issue #17 artifacts generated."
