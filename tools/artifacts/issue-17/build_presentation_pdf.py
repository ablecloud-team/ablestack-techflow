#!/usr/bin/env python3
"""Assemble rendered Issue #17 slide PNGs into a presentation PDF."""
...
SLIDES_DIR = ROOT / "tmp" / "artifacts" / "issue-17" / "rendered"
OUTPUT = ROOT / "output" / "pdf" / "techflow-observability-presentation.pdf"
...
def build() -> None:
    ...
    pdf.setTitle("TechFlow 로그·메트릭·상태 점검")
