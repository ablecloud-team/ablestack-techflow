...
RENDERS = ROOT / "tmp/artifacts/issue-21/qa/renders"
OUTPUT = ROOT / "output/pdf/techflow-community-assist-presentation.pdf"
...
def main() -> None:
    ...
    for image in images:
        pdf.drawImage(ImageReader(str(image)), 0, 0, width=1280, height=720)
        pdf.showPage()
    pdf.save()
