# ABLESTACK Assist 종합·멀티모달 배포·운영 Runbook
...
sed -i 's/^TECHFLOW_RAG_RELEASE=.*/TECHFLOW_RAG_RELEASE=issue-58/' .env
...
| Artifact 400 | 형식, 매직 바이트, 크기, 해상도, D0 분류를 확인한다. |
...
시험 서버 백업은 `/home/ablecloud/techflow-ai-gateway-backups/issues56-58-20260811T060003Z`에 보관했다.
