...
class CommunityTests(unittest.TestCase):
    ...
    def test_followup_with_expired_prior_attachment_does_not_return_404(self) -> None:
        ...
        store.create_community_case(first, {"draftAnswer": "이전 분석 요약", "answerState": "ANSWERED",
        ...
        with patch('app.main.standalone_libvirt_tcp_result', return_value={
            ...
            reply = client.post('/v1/community/cases', headers={**HEADERS, 'Idempotency-Key': 'expired-next'},
