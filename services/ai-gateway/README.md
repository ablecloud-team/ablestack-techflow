...
- Community 후속 질문의 구체적인 하위 주제를 전체 대화의 최초 주제보다 먼저 처리합니다.
- Standalone의 libvirt TCP 16509 설정 질문에는 daemon·socket·방화벽·검증·닫기 절차만 답합니다.
- 외부 KVM V2V 기본 답변은 이전 Assistant 답변이 없는 최초 질문에만 적용합니다.
- 16509는 승인된 HCI 관리 IP와 제한된 작업 시간에만 허용하도록 안내합니다.
